...
TEST_CASE("Test continuum pose", "[continuum]")
{
    ...
    mmath::Posef pose = mmath::continuum::calcSingleSegmentPosef(L, theta, delta);
...
TEST_CASE("Test continuum posw with Lr", "[continuum]")
{
    float L = 30;
    float Lr = 10;
    ...
    mmath::Pose pose =
            mmath::continuum::calcSingleWithRigidSegmentPosef(L, theta, delta, Lr);
